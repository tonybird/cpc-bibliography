...
function bibliography_post_type() {
  $biblabels = array(
    ...
    'singular_name'       => _x( 'Bibliographic Entry', 'Post Type Singular Name', 'twentythirteen' ),
    'menu_name'           => __( 'Bibliography', 'twentythirteen' ),
    'parent_item_colon'   => __( 'Parent  Item', 'twentythirteen' ),
    'all_items'           => __( 'All Bibliographic Entries', 'twentythirteen' ),
    'view_item'           => __( 'View Bibliographic Entry', 'twentythirteen' ),
    'add_new_item'        => __( 'Add New Bibliographic Entry', 'twentythirteen' ),
    'add_new'             => __( 'Add New', 'twentythirteen' ),
    'edit_item'           => __( 'Edit Bibliographic Entry', 'twentythirteen' ),
    'update_item'         => __( 'Update Bibliographic Entry', 'twentythirteen' ),
